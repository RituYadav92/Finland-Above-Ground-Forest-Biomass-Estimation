## BioMassters: A Benchmark Dataset for Forest Biomass Estimation using Multi-modal Satellite Time-series ([NeurIPS 2023](https://openreview.net/attachment?id=hrWsIC4Cmz&name=pdf))
